...
public struct SmolLM3Configuration: Decodable, Sendable {
    ...
    public var noRopeLayers: [Int] // Layers that skip RoPE (1 = skip, 0 = use)
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        ropeTheta = try decode(.ropeTheta, default: 5_000_000.0)
...
typealias SmolLM3RMSNorm = RMSNorm
