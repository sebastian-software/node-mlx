...
typealias Mistral3RMSNorm = RMSNorm
...
class Mistral3ModelInner: Module {
    @ModuleInfo(key: "embed_tokens") var embedTokens: Embedding
    @ModuleInfo(key: "layers") var layers: [Mistral3DecoderLayer]
    @ModuleInfo(key: "norm") var norm: Mistral3RMSNorm
...
public class Mistral3Model: Module, LLMModel {
    ...
    @ModuleInfo(key: "model") var model: Mistral3ModelInner
    ...
    public init(_ config: Mistral3Configuration) {
        ...
        numKVHeads = config.numKeyValueHeads
        headDim = config.headDim
        _model.wrappedValue = Mistral3ModelInner(config)
