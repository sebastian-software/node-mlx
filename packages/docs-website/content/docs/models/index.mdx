...
```typescript
loadModel("qwen") // Qwen3-4B (default, best balance)
loadModel("qwen-3-8b") // Larger, better quality
loadModel("qwen-3-32b") // Premium quality
```

| Variant      | Parameters | Memory | Speed     | Best For        |
| ------------ | ---------- | ------ | --------- | --------------- |
| `qwen`       | 4B         | ~5 GB  | 120 tok/s | **Recommended** |
| `qwen-3-8b`  | 8B         | ~8 GB  | 90 tok/s  | Complex tasks   |
| `qwen-3-32b` | 32B        | ~20 GB | 40 tok/s  | Premium quality |
